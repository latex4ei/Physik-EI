...
%\begin{emphbox}
%Beispielsweise Textcolor anstatt emphbox verwenden und alle wichtige Formell mit rot bzw. einer anderen Farbe schreiben.
\textcolor{red}{$\vec{F_c}=2m(v\times \omega)= 2m v w \cdot \sin{(v\angle \omega)}$}\\
%\end{emphbox}
